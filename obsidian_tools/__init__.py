...
subcommands land as their own tickets are implemented. See ../DESIGN.md for the target architecture,
../docs/ for the design canon it implements, and the epic ppat/homelab-ops-kubernetes-apps#3439 for
sequencing.
"""
