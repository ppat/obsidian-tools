...
See `cycle.py` for the five-step cycle (compare, capture, pull, publish, advance) and its module
docstring for the ordering rationale and the one-parked-clone simplification.
"""
